...
public class AddressActivity extends AppCompatActivity implements AddressAdapter.SelectedAddress{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.address_toolbar2);
...
//After Detailed buyNow.setclicklistener
        paymentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AddressActivity.this, com.example.ecommerceapp.activity.PaymentActivity.class);
     ...
     addAddress.setOnClickListener(new View.OnClickListener() {
         @Override
         public void onClick(View v) {
             startActivity(new Intent(AddressActivity.this, com.example.ecommerceapp.activity.AddAddressActivity.class));
         }
     });
